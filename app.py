...
if not st.session_state.logged:
    st.markdown("""
    <style>
    /* VitaminCare landing / authentication screen */
    .stApp {
    ...
    /* Streamlit button reset for the two auth choices */
    ...
    # Show the actual account form only after the user chooses an option.
